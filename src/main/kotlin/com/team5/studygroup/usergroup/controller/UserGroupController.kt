                    ...
                    Content(
                        ...
                        examples = [
                            ExampleObject(
                                ...
                                value = """{"errorCode": 3005, "message": "현재 모집 중인 그룹이 아닙니다.", "timestamp": "2026-02-03T22:00:00"}""",
                            ),
                            ExampleObject(
                                name = "정원 초과 (3006)",
                                summary = "가입 인원이 capacity에 도달한 경우",
                                value = """{"errorCode": 3006, "message": "그룹의 정원이 가득 차서 가입할 수 없습니다.", "timestamp": "2026-02-03T22:00:00"}""",
                            ),
                        ],
                    ),
                ],
                ...
                content = [
                    Content(
                        ...
                        examples = [
                            ExampleObject(
                                name = "그룹 없음 (3001)",
                                value = """{"errorCode": 3001, "message": "해당 그룹을 찾을 수 없습니다.", "timestamp": "2026-02-03T22:00:00"}""",
                            ),
                        ],
                    ),
                ],
                ...
                content = [
                    Content(
                        ...
                        examples = [
                            ExampleObject(
                                name = "이미 가입됨 (3002)",
                                value = """{"errorCode": 3002, "message": "이미 가입한 그룹입니다.", "timestamp": "2026-02-03T22:00:00"}""",
                            ),
                        ],
                    ),
                ],
                ...
                content = [
                    Content(
                        ...
                        examples = [
                            ExampleObject(
                                name = "가입 정보 없음 (3003)",
                                value = """{"errorCode": 3003, "message": "가입한 그룹이 아닙니다.", "timestamp": "2026-02-03T22:00:00"}""",
                            ),
                        ],
                    ),
                ],
